...
A = load '/user/acadgild/data/batch_$batch/web/file.xml' using org.apache.pig.piggybank.storage.XMLLoader('record') as (x:chararray);
...
STORE B INTO '/user/acadgild/data/batch_$batch/web/xml_csv${batch}' USING PigStorage(',');
